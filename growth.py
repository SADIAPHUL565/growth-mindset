...
st.title("🧿 DataSweeper Sterling Integrator By Sadia Phul")
...
upload_file = st.file_uploader("Upload your files (accepts CSV or Excel)", type=["csv", "xlsx"], accept_multiple_files=True)
